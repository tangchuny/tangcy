<template>
	<section>
		...
		<el-col :span="12" style="padding-bottom: 0px;" class="c-tr">
			  ...
			  <el-button type="info">批量转入线下</el-button>
		</el-col>
		<!--列表-->
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="price" label="总金额"  sortable>
			</el-table-column>
			<el-table-column prop="price" label="提币地址余额"  sortable>
			</el-table-column>
			<el-table-column prop="walletAddr" label="提币地址"  sortable>
			</el-table-column>
			<el-table-column prop="walletAddr" label="冷钱包地址"  sortable>
			</el-table-column>
			...
			<el-table-column label="操作" align="center" width="200">
					<template slot-scope="scope">
						...
						<el-button round @click="detail(scope.row)">转入线下</el-button>
				</template>
			</el-table-column>
		</el-table>
