<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="email" label="买方用户账号"  sortable>
			</el-table-column>
			<el-table-column prop="email" label="卖方用户账号"  sortable>
			</el-table-column>
			<el-table-column prop="time" label="成交时间"  sortable>
			</el-table-column>
			...
			<el-table-column prop="price" label="买方手续费"  sortable>
			</el-table-column>
			<el-table-column prop="price" label="成交均价"  sortable>
			</el-table-column>
			<el-table-column prop="number" label="成交数量"  sortable>
			</el-table-column>
			<el-table-column prop="price" label="成交总价"  sortable>
			</el-table-column>
