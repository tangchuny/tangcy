<template>
	<section>
		...
		<el-col :span="12" style="padding-bottom: 0px;" class="c-tr">
			<el-button type="primary">充矿工费</el-button>
			<el-button type="primary">归集</el-button>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="price" label="提币地址余额"  sortable>
			</el-table-column>
			<el-table-column prop="price" label="资产余额"  sortable>
			</el-table-column>
			<el-table-column prop="price" label="旷工费余额"  sortable>
			</el-table-column>

			<el-table-column prop="isTrade" label="是否可归集"  sortable>
			...
			<el-table-column label="操作" align="center" width="200">
					<template slot-scope="scope">
						<el-button round @click="edit(scope.row)" size="small">充矿工费</el-button>
						<el-button round @click="detail(scope.row)" size="small">查看</el-button>
				</template>
			</el-table-column>
		</el-table>
