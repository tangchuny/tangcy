<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="walletAddr" label="提币钱包地址" min-width="150" sortable>
			</el-table-column>
			<el-table-column prop="number" label="提币数量" min-width="120" sortable>
			</el-table-column>
			<el-table-column prop="number" label="实际到账数量" min-width="120" sortable>
			</el-table-column>
			<el-table-column prop="price" label="提币手续费" min-width="120" sortable>
			</el-table-column>
			<el-table-column prop="id" label="交易流水号" min-width="120" sortable>
			</el-table-column>
