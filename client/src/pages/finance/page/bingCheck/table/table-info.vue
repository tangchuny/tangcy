<template>
    <div class="">
       <el-table class="o-pt" :data="tableData" ref="table" style="width: 100%"  @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="account3" sortable label="币种名称" align="center" width="100"></el-table-column>
                        <el-table-column prop="account4" label="充币钱包地址" align="center" width="100"></el-table-column>
                        ...
                        <el-table-column prop="account13" label="操作" align="center" width="120">
                             <template slot-scope="scope">
                                <a class="t-link-blue o-pr-m">通过</a>
                                <a class="t-link-blue">驳回</a>
                            </template>
                        </el-table-column>
                    </el-table>
    </div>
