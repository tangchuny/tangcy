<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="coinName" label="币种名称" width="100" sortable>
			</el-table-column>
			<el-table-column prop="number" label="发行量(个)" width="150" sortable>
			</el-table-column>
			<el-table-column prop="price" label="发行单价(￥)" width="150" sortable>
			</el-table-column>
			<el-table-column prop="publicName" label="发行发名称" width="150" sortable>
			</el-table-column>
			<el-table-column prop="proType" label="产品状态"  width="130">
				<template slot-scope="scope">
					<span :class="{'c-color-s': scope.row.proType, 'c-color-e': !scope.row.proType}">
						{{ scope.row.proType == true ? '发行中...' : '已关闭'}}
					</span>
				</template>
			</el-table-column>
			<el-table-column prop="time" label="发行时间" width="160" sortable>
			</el-table-column>
			<el-table-column prop="google" label="交易状态" >
				 <template slot-scope="scope">
						<el-switch
			...
			<el-table-column label="操作" align="center" width="250">
					<template slot-scope="scope">
						<el-button round @click="setting(scope.row)">配置交易参数</el-button>
