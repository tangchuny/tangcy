<template>
	<section>
		...
		<el-col :span="6" style="padding-bottom: 0px;" class="c-tr">
			  <el-button type="primary" round @click.native="edit(null)">添加交易对</el-button>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="price" label="初始价格"  sortable>
			</el-table-column>
